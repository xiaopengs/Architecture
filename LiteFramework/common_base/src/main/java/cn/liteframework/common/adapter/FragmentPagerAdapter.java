package cn.liteframework.common.adapter;
...
import cn.liteframework.common.base.BaseFragment;
...
public class FragmentPagerAdapter extends FragmentStatePagerAdapter {
    private List<cn.liteframework.common.bean.HorizontalTabTitle> titles;
    private List<BaseFragment> fragments;

    /**
     * 使用该构造方法 必须重写 getTabFragment 返回对应的Fragment
     */
    public FragmentPagerAdapter(FragmentManager fm, List<cn.liteframework.common.bean.HorizontalTabTitle> titles) {
        this(fm, titles, null);
    }

    public FragmentPagerAdapter(FragmentManager fm, List<cn.liteframework.common.bean.HorizontalTabTitle> titles, List<BaseFragment> fragments) {
        super(fm);
        this.titles = titles;
