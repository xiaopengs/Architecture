...
import cn.liteframework.common.activity.WebViewActivity;
import cn.liteframework.common.base.bean.BaseBean;
...
public class ActivityToActivity {
    ...
    public static void toActivity(Context activity, cn.liteframework.common.bean.Template template) {
